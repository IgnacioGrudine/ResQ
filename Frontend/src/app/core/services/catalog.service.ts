...
import { PackListItem, PackDetail, MerchantDetail } from '../models/catalog.models';
...
export class CatalogService {
  ...
  getPackDetail(id: number): Observable<PackDetail> {
    return this.http.get<PackDetail>(`/api/catalog/packs/${id}`);
  }
